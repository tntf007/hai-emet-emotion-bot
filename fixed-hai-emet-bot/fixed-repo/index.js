...
console.log('  - GEMINI_KEY:', GEMINI_KEY ? '✅ Available (not used in D5 mode)' : '❌ Missing');
...
${D5_CONFIG.tokensStatus.gemini ? '✅' : '❌'} Gemini (backup)
${D5_CONFIG.tokensStatus.gas_ultimate ? '✅' : '❌'} GAS Ultimate

✅ ${Object.values(D5_CONFIG.tokensStatus).filter(Boolean).length}/${Object.keys(D5_CONFIG.tokens).length} טוקנים פעילים!
